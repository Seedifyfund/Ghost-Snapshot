...
userRoute.get('/genstksnapshot', [ auth.isAuthenticatedUser, UserCtr.seedStakingSnapshot]);
...
userRoute.post('/dump-stk-usr', [multipartMiddleware, UserCtr.addjustStkCal])
